...
_TEXT = {
    "en": {
        "settings": "Settings", "game_folder": "Game folder", "developer_mode": "Developer Mode", "developer_hint": "Show technical IDs and asset sources", "language": "Language", "theme": "Theme",
        ...
        "unsupported_key_text": "Command-bar hotkeys support one A-Z or 0-9 key without modifiers.", "global_applied": "Global hotkeys applied safely. Restart the game to load them.",
    ...
    "uk": {
        "settings": "Налаштування", "game_folder": "Папка гри", "developer_mode": "Режим розробника", "developer_hint": "Показувати технічні ID та джерела ресурсів", "language": "Мова", "theme": "Тема",
        ...
        "unsupported_key_text": "Хоткеї command bar підтримують одну клавішу A-Z або 0-9 без модифікаторів.", "global_applied": "Глобальні хоткеї безпечно застосовано. Перезапустіть гру.",
    ...
    "ru": {
        "settings": "Настройки", "game_folder": "Папка игры", "developer_mode": "Режим разработчика", "developer_hint": "Показывать технические ID и источники ресурсов", "language": "Язык", "theme": "Тема",
        ...
        "unsupported_key_text": "Клавиши command bar поддерживают одну клавишу A-Z или 0-9 без модификаторов.", "global_applied": "Глобальные клавиши безопасно применены. Перезапустите игру.",
